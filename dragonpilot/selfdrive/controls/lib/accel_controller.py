...
A_MAX_V = {
  AccelPersonality.eco:       [1.60, 1.50, 1.30, 1.20,  1.10, 0.80, 0.60, 0.50,  0.40, 0.30, 0.12, 0.08],
  AccelPersonality.normal:    [2.00, 1.60, 1.50, 1.40,  1.30, 1.10, 0.90, 0.70,  0.50, 0.40, 0.24, 0.10],
