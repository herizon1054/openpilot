...
修改實驗模式加速意願  目前已修改類似一般模式油門加速方式    0.1

AEM修改項目 
         
         追加車速開關 80KM以下切實驗模式 90KM以上切一般模式   側向G力超過0.15G 切換一般模式過彎減速 

         追加打方向燈就切換回原本的加速意願0.4(不太願意加速)但是遇到彎道例外

         追加遇到紅綠燈 40米就切換0.3加速意圖
         
         車速60KM以下0.2加速意圖  70KM以上0.1加速意圖
