dragonpilot 0.11.1  (2026-09-26)  herizon1054 自訂版 請注意安全
=======================
* 此分支針對性優化 Toyota Altis 與 Toyota Corolla Cross 其餘豐田車型請勿使用
* 追加車道線置中模式 採漸進式 車速60km達到你所設定的百分比 e2e比例越高 越不置中 (此為測試功能請注意)
* acc控制器穩定性提升
* AEM修復   30KM以下實驗模式  70KM以下遇到紅綠燈10米內會短暫切換實驗模式  轉向角度過大 會切換到DTSC
* RADARD追加雷達備援夜間強化 備註:靜止車無法辨識!!


dragonpilot 0.11.1  (2026-09-10)  herizon1054 自訂版 請注意安全
=======================
* 追加紅綠燈模組(一般模式與實驗模式均可用) (此為測試功能請注意)


dragonpilot 0.11.1  (2026-08-16)  herizon1054 自訂版 請注意安全
=======================
* acc控制器穩定性提升

dragonpilot 0.11.1  (2026-08-07)  herizon1054 自訂版 請注意安全
=======================
* 追加ltd 同sp的車道轉向意圖 根據台灣環境優化運作條件
* 追加tdx 國道上顯示前方車速與事件(需聯網)
* 修改 panda連線速度與開機速度
* 修改ocm 超車滑行 當前車距離三秒以上 車速超過定速+20 放開油門後 會用滑行回到定速
