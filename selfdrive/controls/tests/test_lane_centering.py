...
@pytest.mark.parametrize(
  ...
  [
    ...
    {"active": False},
    {"valid": False},
    {"speed": 4.0},  # < _MIN_V_EGO (20 km/h ≈ 5.5556 m/s)
  ],
)
...
def test_min_v_ego_is_20kph_not_18kph():
  model = _model(left=-1.5, right=2.1)
  just_below = 20.0 / 3.6 - 0.05  # 略低於新門檻
  just_above = 20.0 / 3.6 + 0.05  # 略高於新門檻，且高於舊的 18 km/h 門檻
